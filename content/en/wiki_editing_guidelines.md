...
slug: "wiki_editing_guidelines"
locale: "en"
source_file: "wiki_editing_guidelines"
original_url: "https://meadmaking.wiki/en/wiki_editing_guidelines"
---
...
Read the [Please Help](/en/please_help) page, and keep it updated. If you are the primary author of an article, add it to the "Proof Read" section.
...
* Example: If writing about spices, it probably goes under /wiki/**ingredients**/herbs\_and\_spices.
* Example: If writing about temperature because you've seen it asked 3 times in the last week, it probably belongs under /wiki/**faq**/fermentation\_temperature, but it might *also* belong in /wiki/**process**/fermentation
...
* Example: /wiki/faq/glass\_vs\_plastic
* Example: /wiki/mazers/curt\_stock
* Example: /wiki/meaderies/schramms\_mead
